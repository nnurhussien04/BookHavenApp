...
Future<Book> getBookDetails(int id) async{
  var request = await http.get(Uri.parse("https://api.bigbookapi.com/$id?api-key=b6c52e13fd6d44b0904098825a6ad866"));
  if(request.statusCode == 200){
    return Book.fromJson(jsonDecode(request.body) as Map<String,dynamic>);
  } else{
    throw Exception('Failed to load books');
  }
