...
import 'package:bookhaven/ui/screen/details_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    itemBuilder: (context, index) {
      ...
      return GestureDetector(
        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (ctx)=> DetailsPage(book: catalogue.books[index],selectedGenre: selectedGenre))),
        child: Card(
          color: Colors.white,
          clipBehavior: Clip.hardEdge,
